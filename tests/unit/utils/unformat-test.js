...
module('Unit | Utility | unformat', function () {
    ...
    test('it unformats a positive integer value', function (assert) {
        ...
        assert.strictEqual(result, 12345, 'Should unformat a positive integer value correctly');
    });
    ...
    test('it unformats a negative float value', function (assert) {
        ...
        assert.strictEqual(result, -1.99, 'Should unformat a negative float value correctly');
    });
    ...
    test('it unformats a string with formatting characters', function (assert) {
        ...
        assert.strictEqual(result, 12345678.9, 'Should unformat a string with formatting characters correctly');
    });

    // Test case 4: Test with an empty string
    test('it unformats an empty string', function (assert) {
        let result = unformat('');
        assert.strictEqual(result, 0, 'Should unformat an empty string to 0');
    });
