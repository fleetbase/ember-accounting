...
module('Unit | Utility | format-money', function () {
    ...
    test('it formats a positive integer with default options', function (assert) {
        ...
        assert.strictEqual(result, '$12,345,678.00', 'Should format a positive integer with default options correctly');
    });
    ...
    test('it formats a positive float with custom symbol and separators', function (assert) {
        ...
        assert.strictEqual(result, '€4.999,99', 'Should format a positive float with custom symbol and separators correctly');
    });
    ...
    test('it formats a negative integer with custom precision', function (assert) {
        ...
        assert.strictEqual(result, '£-500,000', 'Should format a negative integer with custom precision correctly');
    });
    ...
    test('it formats a string representation of a number with default options', function (assert) {
        ...
        assert.strictEqual(result, '$9,876.54', 'Should format a string representation of a number with default options correctly');
    });
});
