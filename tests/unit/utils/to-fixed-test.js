...
module('Unit | Utility | to-fixed', function () {
    ...
    test('it formats a positive float value with default precision', function (assert) {
        ...
        assert.equal(result, '0.62', 'Should format a positive float with default precision (2) correctly');
    });
    ...
    test('it formats a positive float value with custom precision', function (assert) {
        ...
        assert.equal(result, '0.615', 'Should format a positive float with custom precision (3) correctly');
    });
    ...
    test('it formats a negative float value with default precision', function (assert) {
        ...
        assert.equal(result, '-1.23', 'Should format a negative float with default precision (2) correctly');
    });
    ...
    test('it formats a large float value with custom precision', function (assert) {
        ...
        assert.equal(result, '12345.6789', 'Should format a large float with custom precision (4) correctly');
    });
    ...
    test('it formats zero with default precision', function (assert) {
        ...
        assert.equal(result, '0.00', 'Should format zero with default precision (2) correctly');
    });
    ...
    test('it formats a string representation of a float with custom precision', function (assert) {
        ...
        assert.equal(result, '12.345', 'Should format a string representation of a float with custom precision (3) correctly');
    });
});
